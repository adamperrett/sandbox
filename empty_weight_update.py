...
general algorithm flow:
 - run a network on multiple inputs
 - if it should have spiked but didn't, increase weights
 - if it did spike and shouldn't have reduce the weights
 - if class is classified correctly do not change the weights
'''
...
def run_and_update(weight_matrix, delay_matrix, print_update=True):
    ...
    ###################################################################
    # add weight updates here, most likely as a function from network #
    ###################################################################
    if print_update:
        print "total update:\n", weight_update
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        weight_update, activations, output_v = run_and_update(weight_matrix, delay_matrix)
